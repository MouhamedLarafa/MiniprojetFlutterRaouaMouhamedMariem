...
class DatabaseHelper {
  ...
  //insertion family composants
  Future<int> saveFamily(FamillesComposants famillesComposants) async {
    var dbClient = await db;
    int res = await dbClient.insert("FamillesComposants", famillesComposants.toMap());
    List<Map> list = await dbClient.rawQuery('SELECT * FROM FamillesComposants');
    print(list);
    return res;
  }
}
